...
const Faq = ({ faqs }) => (
    <div className="relative w-full px-6 pt-10 pb-8 mt-20 bg-white shadow-xl dark:bg-gray-800 ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-2xl sm:rounded-lg sm:px-10">
