...
const TabButton = memo(({ active, onClick, children, variant = 'underline' }) => {
    const styles = {
        base: 'whitespace-nowrap py-2 px-6 font-medium text-sm',
        underline: {
            active: 'border-teal-500 text-teal-600',
            inactive: 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-white'
        },
        solid: {
    ...
    const variantClass = variant === 'underline' ? 'border-b-2' : 'rounded-t-lg';
