...
export default function BaseLaporanData({
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: "Email",
        accessor: "mahasiswa.email",
        sortable: true,
      },
      {
        Header: "Angkatan",
        accessor: "mahasiswa.angkatan",
        sortable: true,
      },
      {
        Header: "Pembimbing",
      ...
      },
      {
        ...
        Cell: ({ row }) => {
          ...
          return laporan?.file ? (
            <a
              href={route("files.laporan", laporan.file.split("/").pop())}
              target="_blank"
                ...
                value={
                  bulkUpdateData.status
                    ? {
                        ...
                        label:
                          bulkUpdateData.status.charAt(0).toUpperCase() +
                          bulkUpdateData.status.slice(1),
                      }
                    : null
                }
                options={[
