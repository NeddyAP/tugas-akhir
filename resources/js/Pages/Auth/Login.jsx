            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    ...
                    <div className="relative">
                        <input
                            type="email"
                            id="email"
                            className={`w-full px-3 py-2 pl-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 ${errors.email ? 'border-red-500' : 'border-gray-300'} dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white`}
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        <input
                            type="password"
                            id="password"
                            className={`w-full px-3 py-2 pl-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 ${errors.password ? 'border-red-500' : 'border-gray-300'} dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white`}
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="remember" className="block ml-2 text-sm text-gray-700 dark:text-gray-200">
                            Ingat username
                        </label>
                    </div>
                    <Link href={route('password.request')} className="text-sm text-teal-600 hover:underline">Lupa Password?</Link>
                </div>
                <button
                    type="submit"
